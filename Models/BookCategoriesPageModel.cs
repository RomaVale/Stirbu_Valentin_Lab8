...
namespace Stirbu_Valentin_Lab8.Models
{
    public class BookCategoriesPageModel : PageModel
    {
        public List<AssignedCategoryData> AssignedCategoryDataList;
        public void PopulateAssignedCategoryData(Stirbu_Valentin_Lab8Context context,
        Book book)
        {
        ...
        public void UpdateBookCategories(Stirbu_Valentin_Lab8Context context,
